...
public class ChangePasswordActivity extends AppCompatActivity implements ConnectivityReceiver.ConnectivityReceiverListener {
    ...
    public void validateSrsAdminPassword(View view) {
       ...
       // checkInternetConnection();
        changeSrsAdminPassword(mOldPassword.getEditText().getText().toString().trim(), mNewPassword.getEditText().getText().toString().trim(), mConfirmPassword.getEditText().getText().toString().trim());
    ...
    // this is the method for change admin password in server
    private void changeSrsAdminPassword(final String oldPassword, final String newPassword, final String confirmPassword) {
        ...
        errorbuilder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                if (error.equals("true")) {
                    ...
                    dialogInterface.dismiss();
                    startActivity(new Intent(ChangePasswordActivity.this, AdminLogin.class).
